...
component{
	...
	this.settings = [
        ...
        { name="facebookshareurl", 	group="Social Pages Options", defaultValue="", type="text", 	label="Facebook Share Link", 	required="false" },
        { name="twittershareurl", 	group="Social Pages Options", defaultValue="", type="text", 	label="Twitter Share Link", 	required="false" },
        { name="googleshareurl", 	group="Social Pages Options", defaultValue="", type="text", 	label="Google+ Share Link", 	required="false" },
         { name="linkedinshareurl", 	group="Social Pages Options", defaultValue="", type="text", 	label="Linkedin Share Link", 	required="false" }
